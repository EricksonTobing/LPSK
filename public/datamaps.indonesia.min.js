!(function (root, factory) {
  ...
  var indonesiaTopo = {
    ...
    /* potongan arcs panjang → ambil langsung dari file JSON Anda */
    arcs: [
      [
        [3778, 10691],
        [67, -50],
  ...
  return function DatamapIndonesia(options) {
    ...
    console.log("DatamapIndonesia initialized with data:", data);
    ...
    // Variabel untuk menyimpan tooltip element
    var tooltip = null;
    ...
    function showTooltip(event, d) {
      try {
        ...
        console.log("showTooltip called for:", prov, "with data:", item);

        // Pastikan tooltip ada
        if (!tooltip) {
          tooltip = createTooltip();
        }

        var value = item && typeof item.value !== "undefined" ? item.value : 0;
        ...
        // Template popup yang disederhanakan
        var htmlContent = "";
        if (
          geographyConfig.popupTemplate &&
          typeof geographyConfig.popupTemplate === "function"
        ) {
          htmlContent = geographyConfig.popupTemplate(d, item);
        } else {
          // Default template
          htmlContent = `
            <div style="padding: 12px; min-width: 180px;">
              ...
              <div style="display: flex; justify-content: space-between; margin-bottom: 4px;">
                ...
                <strong style="color: #2563eb;">${value.toLocaleString(
                  "id-ID"
                )}</strong>
              </div>
        ...
        tooltip.html(htmlContent).style("opacity", 0);
    ...
    function updateTooltipPosition(event) {
      ...
      var tooltipWidth = tooltipNode.offsetWidth || 200;
      var tooltipHeight = tooltipNode.offsetHeight || 100;

      var x = event.pageX + 10;
      var y = event.pageY - tooltipHeight - 10;

      // Adjust jika tooltip keluar dari viewport
    ...
    var paths = svg
      ...
      .style("stroke", geographyConfig.borderColor || "#fff")
      .style("stroke-width", geographyConfig.borderWidth || "1")
      ...
      .on("mouseover", function (event, d) {
        console.log("Province mouseover:", d.properties.provinsi);

        // Highlight effect
        if (geographyConfig.highlightOnHover !== false) {
          d3.select(this)
            .style("stroke-width", geographyConfig.highlightBorderWidth || "2")
            .style("stroke", geographyConfig.highlightBorderColor || "#fff");

          if (geographyConfig.highlightFillColor) {
            d3.select(this).style(
              "fill",
              geographyConfig.highlightFillColor(d)
            );
          }
        }
      ...
      .on("mousemove", function (event, d) {
        ...
        if (geographyConfig.popupOnHover !== false && tooltip) {
          updateTooltipPosition(event);
        }
      })
      .on("mouseout", function (event, d) {
        console.log("Province mouseout:", d.properties.provinsi);
    ...
    console.log("Map paths created:", paths.size());
    ...
    return {
      ...
      updateChoropleth: function (newData) {
        console.log("updateChoropleth called with:", newData);
        data = newData;
