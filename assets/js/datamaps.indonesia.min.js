    ...
    var paths = svg
      ...
      .on("mouseover", function (event, d) {
        ...
        d3.select(this)
          .style(
            "stroke-width",
            geographyConfig.highlightBorderWidth
              ? parseInt(geographyConfig.highlightBorderWidth) + 1
              : "2"
          )
          .style("stroke", geographyConfig.highlightBorderColor || "#fff");
